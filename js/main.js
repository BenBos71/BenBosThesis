...
//  being stored in the Session Storage
// function session_to_survey()
// {
//     document.getElementById("text1").textContent = sessionStorage.getItem("age");
//     document.getElementById("text2").textContent = sessionStorage.getItem("sex");
// }

    //  This commented out code is simply to show me that values are getting saved to the 
    //  array for storing responses
    // if (document.getElementById("next_submit").textContent == "Submit")
    // {
    //     emotions.push(document.querySelector(".dropbtn").textContent);
    //     document.getElementById("sentence").textContent = emotions;
    // }
    // else
    // {
...
// const uri = "mongodb+srv://johnbos:X3dKVyqnPrNECu7r@contextinsande.kqyawym.mongodb.net/?retryWrites=true&w=majority&appName=ContextInSandE";
...
//         document.getElementById("results").textContent = "Pinged your deployment. You successfully connected to MongoDB!";
//     } catch (error) {
//         console.error("Error connecting to MongoDB:", error);
//         document.getElementById("results").textContent = "Error connecting to MongoDB:";
